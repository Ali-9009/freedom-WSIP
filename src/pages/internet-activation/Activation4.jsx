        ...
        <div className="max-w-6xl mx-auto p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                        ...
                        <div className="mt-8 space-y-4">
                            ...
                            <label className="flex items-start gap-3 p-4 border rounded-lg border-gray-300">
                                <input type="radio" name="install" className="mt-1 accent-sky-600" />
                                <div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-5 space-y-5 h-fit sticky top-20">
                    <div className="bg-sky-600 text-white px-3 py-2 rounded-md font-semibold text-sm">
        ...
        <div>
            ...
            <input
                ...
                ${error
                        ...
                        : "border-gray-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-100"
                    }`}
            />
